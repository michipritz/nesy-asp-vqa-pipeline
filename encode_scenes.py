...
if __name__ == "__main__":
    ...
    parser.add_argument('-m', '--model', type=str,
                        default='utils/config/yolov3_scene_encoder.cfg', help=help_messages['model'])
    ...
    parser.add_argument('--bounding_box_thres', type=float,
                        default=0.5, help=help_messages['bounding_box_thres'])

    parser.add_argument('--nms_thres', type=float,
                        default=0.5, help=help_messages['nms_thres'])

    parser.add_argument('--alpha', type=float,
                        default=1.0, help=help_messages['alpha'])

    parser.add_argument('-k', '--k', type=int,
                        default=1, help=help_messages['k'])
    ...
    # Write meta information to the output file
    ...
    # Add computed confidence mean and std to meta information in output file
